...
int main() {
    std::cout << std::boolalpha << containsNearbyDuplicate({1, 2, 3, 1}, 3) << " (expected true)\n"
              << containsNearbyDuplicate({1, 0, 1, 1}, 1) << " (expected true)\n"
              << containsNearbyDuplicate({1, 2, 3, 1, 2, 3}, 2) << " (expected false)\n";
    return 0;
}
