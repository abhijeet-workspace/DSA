...
void printInvoice(const std::string& client, const std::vector<InvoiceItem>& items) {
    ...
    std::cout << std::left << std::setw(20) << "Item Name" << std::right << std::setw(6) << "Qty"
              << std::setw(12) << "Unit Price" << std::setw(12) << "Total" << "\n";
    ...
    for (const auto& item : items) {
        ...
        std::cout << std::left << std::setw(20) << item.name << std::right << std::setw(6)
                  << item.quantity << std::setw(12) << item.unitPrice << std::setw(12) << total
                  << "\n";
    }

    std::cout << std::setfill('-') << std::setw(50) << "" << std::setfill(' ') << "\n";
    std::cout << std::right << std::setw(38) << "GRAND TOTAL:" << std::setw(12) << grandTotal
              << "\n";
    std::cout << "========================================\n";
}
...
int main() {
    ...
    std::vector<InvoiceItem> items = {{"MacBook Pro M3", 1, 1999.00},
