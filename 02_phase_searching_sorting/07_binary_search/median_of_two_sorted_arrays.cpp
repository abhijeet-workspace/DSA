...
std::vector<int> mergeTwoSortVector(const std::vector<int>& nums1, const std::vector<int>& nums2) {
...
double findMedianSortedArraysBrute(const std::vector<int>& nums1, const std::vector<int>& nums2) {
...
int main() {
    ...
    std::cout << "brute:   " << findMedianSortedArraysBrute(nums1, nums2) << " (expected 2)\n";
    std::cout << "optimal: " << findMedianSortedArrays(nums1, nums2) << " (expected 2)\n";
    return 0;
}
