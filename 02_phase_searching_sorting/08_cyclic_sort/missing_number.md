...
- **Time:** O(N)
- **Space:** O(1) auxiliary (mutates input)
...
Find the Duplicate Number (287); First Missing Positive (41); Set Mismatch (645).

## 11. Tags
`cyclic-sort`, `array`, `math`, `leetcode-268`, `difficulty:easy`
