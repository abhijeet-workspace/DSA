...
|-------------|-------------------|
| Stack of times | Equivalent; reverse scan is enough |
| Step simulation | Harder correctness with continuous speeds |
...
## 11. Tags
`sorting`, `stack`, `greedy`, `leetcode-853`, `difficulty:medium`
